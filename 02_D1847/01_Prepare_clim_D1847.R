...
select <- c("Ptot-6", "Ptot-7", "DC-8", "Tmean-8", "Sftot-9", "Sftot1", "Sftot3", "Tmean4", "Tmean6", "Ptot8")
# noms qui apparaitront dans le modèle final
namesclimvar <- c("Pp6", "Pp7", "DCp8", "Tp8", "Sp9", "S1", "S3", "T4", "T6", "P8")
...
clim<-read.csv("~/ownCloud/Scan & measures/Climate/PTSF18231847.csv", sep=",")
...
# Import Degree Day
clim1<-read.csv("~/ownCloud/Scan & measures/Climate/DD18231847.csv", sep=",")
...
# Import Drought Code
clim1<-read.csv("~/ownCloud/Scan & measures/Climate/DC18231847.csv", sep=",")
clim1[,"year"]<-as.integer(substr(clim1[,1],1,4))
clim1[,"month"]<-as.integer(substr(clim1[,1],6,7))
clim1<-clim1[,-1]
...
clim1<-read.csv("~/ownCloud/Scan & measures/Climate/GSL18231847.csv", sep=",")
clim1[,"month"] <- 6
clim1 <- clim1[, -c(2,3)]
...
write.csv(clim, "~/ownCloud/Work_directory/Analysis/chapitre_2/interactions/input_clim/clim1847.csv")
