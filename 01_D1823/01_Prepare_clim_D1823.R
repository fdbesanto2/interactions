...
select <- c("DC-7", "Tmean-8", "DC-9", "Tmean2", "Sftot3", "Ptot6", "Tmean6", "DC7", "Tmean8")
# noms qui apparaitront dans le modèle final
namesclimvar <- c("DCp7", "Tp8", "DCp9", "T2", "S3", "P6", "T6", "DC7", "T8")
...
write.csv(clim, "~/ownCloud/Work_directory/Analysis/chapitre_2/interactions/input_clim/clim1823.csv")
